...
def battery_geometry(L):
    ...
    g.spline([0, 1], 0, marker=Boundaries.NONE_BOUNDARY)
    g.circle([1, 2, 3], 1, marker=Boundaries.WARM_CIRCLE)
    g.circle([3, 2, 4], 2, marker=Boundaries.WARM_CIRCLE)
    g.spline([4, 5], 3, marker=Boundaries.NONE_BOUNDARY)
    g.spline([5, 6], 4, marker=Boundaries.TOP_BATTERY)
    g.spline([6, 7], 5, marker=Boundaries.FIXED_BOUNDARY)
    g.spline([7, 0], 6, marker=Boundaries.FIXED_BOUNDARY)

    # circle 1
    g.circle([9, 8, 10], 7, marker=Boundaries.COOL_CIRCLE)
    g.circle([10, 8, 11], 8, marker=Boundaries.COOL_CIRCLE)
    g.circle([11, 8, 12], 9, marker=Boundaries.COOL_CIRCLE)
    g.circle([12, 8, 9], 10, marker=Boundaries.COOL_CIRCLE)

    # circle 2
    g.circle([14, 13, 15], 11, marker=Boundaries.WARM_CIRCLE)
    g.circle([15, 13, 16], 12, marker=Boundaries.WARM_CIRCLE)
    g.circle([16, 13, 17], 13, marker=Boundaries.WARM_CIRCLE)
